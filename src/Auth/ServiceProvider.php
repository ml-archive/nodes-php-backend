...
class ServiceProvider extends IlluminateAuthServiceProvider
{
    ...
    private function defineGates(GateContract $gate) {
        ...
        // Define super admin
        $gate->define('backend-developer', function ($authedUser) {
            return $authedUser->user_role == 'developer';
        });

        $gate->define('backend-super-admin', function ($authedUser) {
            return in_array($authedUser->user_role, ['developer', 'super-admin']);
        });

        // Define admin
        $gate->define('backend-admin', function ($authedUser) {
        ...
        $gate->define('backend-edit-user', function ($authedUser, $user = null) {
