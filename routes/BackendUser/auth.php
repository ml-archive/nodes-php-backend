<?php
Route::group(['namespace' => 'Nodes\Backend\Http\Controllers', 'prefix' => 'admin/login', 'middleware' => ['ssl']], function() {
    // Login form
    Route::get('/', [
...
// Manager auth
Route::group(['namespace' => 'Nodes\Backend\Http\Controllers', 'prefix' => 'admin/manager_auth/', 'middleware' => ['ssl']], function() {
