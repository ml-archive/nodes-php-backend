<svg width="48px" height="48px" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
    <defs>
        <linearGradient x1="0%" y1="100%" x2="100%" y2="0%" id="logoGradient">
    ...
    <g id="00_Guides-/-00.00_Mobile" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
        <g id="00_Guides/00.00_Mobile/00.00_Mobile_Start" sketch:type="MSArtboardGroup" transform="translate(-136.000000, -48.000000)" fill="url(#logoGradient)">
